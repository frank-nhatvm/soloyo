...
class Soloyo_Productupload_Block_Adminhtml_Requestproduct_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('productupload/adminhtml_requestproduct_edit_tab_form')
                                ->toHtml(),
        ));
