...
class Soloyo_Productupload_Block_Adminhtml_Mockup_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('mockup_data')
            && Mage::registry('mockup_data')->getId()
        ) {
            return Mage::helper('productupload')->__("Edit Item '%s'",
                $this->htmlEscape(Mage::registry('mockup_data')->getTitle())
            );
        }
