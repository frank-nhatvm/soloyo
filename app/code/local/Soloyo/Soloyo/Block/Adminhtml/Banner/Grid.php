...
class Soloyo_Soloyo_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('soloyo/homebanner')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('image', array(
            ...
            'width'     => '150px',
            'index'     => 'image',
            'renderer' => 'Soloyo_Soloyo_Block_Adminhtml_Renderer_Bannerimage'
        ));
