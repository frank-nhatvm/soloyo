...
class Soloyo_Soloyo_Block_Adminhtml_Cate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('cateGrid');
        $this->setDefaultSort('home_cate_id');
    ...
    {
        $collection = Mage::getModel('soloyo/homecate')->getCollection();
    ...
    {
        $this->addColumn('home_cate_id', array(
        ...
        $this->addColumn('image', array(
            ...
            'width'     => '150px',
            'index'     => 'image',
            'renderer' => 'Soloyo_Soloyo_Block_Adminhtml_Renderer_Cateimage'
        ));
    ...
    {
        $this->setMassactionIdField('home_cate_id');
        $this->getMassactionBlock()->setFormFieldName('homecate');
