...
class Soloyo_Soloyo_Block_Adminhtml_Cate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('homecate_data')
            && Mage::registry('homecate_data')->getId()
        ) {
            return Mage::helper('soloyo')->__("Edit Item '%s'",
                                                $this->htmlEscape(Mage::registry('homecate_data')->getName())
            );
        }
