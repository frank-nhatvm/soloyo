 ...
 * Time: 9:13 AM
 */
class Soloyo_Brandmodel_Block_Adminhtml_Modelmobile_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('modelmobileGrid');
        $this->setDefaultSort('modelmobile_id');
    ...
    {
        $collection = Mage::getModel('brandmodel/modelmobile')->getCollection();
    ...
    {
        $this->addColumn('modelmobile_id', array(
            'header'    => Mage::helper('brandmodel')->__('ID'),
            'align'     =>'right',
            'width'     => '50px',
            'index'     => 'modelmobile_id',
        ));
    ...
    {
        $this->setMassactionIdField('modelmobile_id');
        $this->getMassactionBlock()->setFormFieldName('modelmobile');
