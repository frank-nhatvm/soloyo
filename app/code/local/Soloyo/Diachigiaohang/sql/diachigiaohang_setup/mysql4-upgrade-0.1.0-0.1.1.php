...
$setup->addAttribute("customer_address", "xaphuong", array(
    'type' => 'varchar',
    'input' => 'text',
    'label' => 'Xa phuong',
    'global' => 1,
...
$attribute = Mage::getSingleton("eav/config")->getAttribute("customer_address", "xaphuong");

$setup->addAttributeToGroup(
    $entityTypeId, $attributeSetId, $attributeGroupId, 'xaphuong', '999'  //sort_order
);
...
$installer->getConnection()
    ->addColumn($sales_quote_address, 'xaphuong', array(
        'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
        'comment' => 'New Xa phuong Field Added'
    ));
...
$installer->getConnection()
    ->addColumn($sales_order_address, 'xaphuong', array(
        'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
        'comment' => 'New xa phuong Field Added'
    ));
...
$html .= '{{depend xaphuong}}<br/>xaphuong:{{var xaphuong}} {{/depend}}';
...
$text .= '{{depend xaphuong}}<br/>xaphuong:{{var xaphuong}} {{/depend}}';
...
$oneline .= '{{depend xaphuong}}<br/>xaphuong:{{var xaphuong}} {{/depend}}';
...
$pdf .= '{{depend xaphuong}}<br/>xaphuong:{{var xaphuong}} {{/depend}}';
...
$js_template .= '{{depend xaphuong}}<br/>xaphuong:{{var xaphuong}} {{/depend}}';
