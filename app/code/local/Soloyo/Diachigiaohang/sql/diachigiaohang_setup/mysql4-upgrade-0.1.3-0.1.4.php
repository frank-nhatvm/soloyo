...
$setup->addAttribute("customer_address", "citylabel", array(
    'type' => 'varchar',
    'input' => 'text',
...
$attribute = Mage::getSingleton("eav/config")->getAttribute("customer_address", "citylabel");

$setup->addAttributeToGroup(
    $entityTypeId, $attributeSetId, $attributeGroupId, 'citylabel', '2999'  //sort_order
);
...
$installer->getConnection()
    ->addColumn($sales_quote_address, 'citylabel', array(
        'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
        'comment' => 'New City label Field Added'
    ));
...
$installer->getConnection()
    ->addColumn($sales_order_address, 'citylabel', array(
        'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
        'comment' => 'New city label Field Added'
    ));
...
$html .= '{{depend citylabel}}<br/>citylabel:{{var citylabel}} {{/depend}}';
...
$text .= '{{depend citylabel}}<br/>citylabel:{{var citylabel}} {{/depend}}';
...
$oneline .= '{{depend citylabel}}<br/>citylabel:{{var citylabel}} {{/depend}}';
...
$pdf .= '{{depend citylabel}}<br/>citylabel:{{var citylabel}} {{/depend}}';
...
$js_template .= '{{depend citylabel}}<br/>citylabel:{{var citylabel}} {{/depend}}';
