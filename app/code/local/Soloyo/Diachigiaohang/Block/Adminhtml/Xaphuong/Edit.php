...
class Soloyo_Diachigiaohang_Block_Adminhtml_Xaphuong_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('xaphuong_data')
            && Mage::registry('xaphuong_data')->getId()
        ) {
            return Mage::helper('diachigiaohang')->__("Edit Item '%s'",
                                                $this->htmlEscape(Mage::registry('xaphuong_data')->getTitle())
            );
        }
