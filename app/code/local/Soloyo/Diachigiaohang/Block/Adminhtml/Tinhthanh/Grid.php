...
class Soloyo_Diachigiaohang_Block_Adminhtml_Tinhthanh_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('tinhthanhGrid');
        $this->setDefaultSort('tinhthanh_id');
    ...
    {
        $collection = Mage::getModel('diachigiaohang/tinhthanh')->getCollection();
    ...
    {
        $this->addColumn('tinhthanh_id', array(
        ...
        $this->addColumn('ten_tinhthanh', array(
    ...
    {
        $this->setMassactionIdField('tinhthanh_id');
        $this->getMassactionBlock()->setFormFieldName('tinhthanh');
