...
class Soloyo_Diachigiaohang_Block_Adminhtml_Tinhthanh_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('tinhthanh_data')
            && Mage::registry('tinhthanh_data')->getId()
        ) {
            return Mage::helper('diachigiaohang')->__("Edit Item '%s'",
                                                $this->htmlEscape(Mage::registry('tinhthanh_data')->getTitle())
            );
        }
