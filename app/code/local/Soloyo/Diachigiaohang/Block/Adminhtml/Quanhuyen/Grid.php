...
class Soloyo_Diachigiaohang_Block_Adminhtml_Quanhuyen_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('quanhuyenGrid');
        $this->setDefaultSort('quanhuyen_id');
    ...
    {
        $collection = Mage::getModel('diachigiaohang/quanhuyen')->getCollection();
    ...
    {
        $this->addColumn('quanhuyen_id', array(
        ...
        $this->addColumn('ten_quanhuyen', array(
    ...
    {
        $this->setMassactionIdField('quanhuyen_id');
        $this->getMassactionBlock()->setFormFieldName('quanhuyen');
