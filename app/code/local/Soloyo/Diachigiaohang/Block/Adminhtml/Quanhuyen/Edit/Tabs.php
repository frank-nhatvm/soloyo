...
class Soloyo_Diachigiaohang_Block_Adminhtml_Quanhuyen_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('quanhuyen_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('diachigiaohang/adminhtml_quanhuyen_edit_tab_form')
                                ->toHtml(),
        ));
