...
class Soloyo_Casedesign_Block_Adminhtml_Caseart_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('caseart_data')
            && Mage::registry('caseart_data')->getId()
        ) {
            return Mage::helper('casedesign')->__("Edit Item '%s'",
                                                $this->htmlEscape(Mage::registry('caseart_data')->getTitle())
            );
        }
