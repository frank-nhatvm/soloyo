...
class Soloyo_Casedesign_Block_Adminhtml_Caseart_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('casedesign/adminhtml_caseart_edit_tab_form')
                                ->toHtml(),
        ));
